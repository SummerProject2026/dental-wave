 ...
 *
 * Flattens the associated User into scalar fields (userId, firstName, lastName, email)
 * so the API layer never exposes JPA-managed entities directly.
 *
 * Offices  → List<OfficeDto>
 * Availabilities → List<AvailabilityDto>
 * TimeOffRequests are excluded here; expose them via a dedicated endpoint.
 */
public class EmployeeDto {
    ...
    /** Remaining time-off balance in days (supports half-day increments) */
    ...
    public EmployeeDto(Long id, Long userId, String firstName, String lastName,
                       String email, String position, List<OfficeDto> offices,
    ...
    public void setOffices(List<OfficeDto> offices) { this.offices = offices; }

    public List<String> getResponsibilities() { return responsibilities; }
    public void setResponsibilities(List<String> r) { this.responsibilities = r; }
    ...
    public void setAvailabilities(List<AvailabilityDto> a) { this.availabilities = a; }
}
